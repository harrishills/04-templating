...
Article.prototype.toHtml = function() {
  ...
  // compiletemplate.tempTitle = this.title;
  // compiletemplate.tempAuthorUrl = this.authorUrl;
  // compiletemplate.tempAuthor = this.author;
  // compiletemplate.tempBody = this.body;
...
// If there is more than one argument, parentheses are necessary for arrow function notation.
rawData.sort((a,b) => {
